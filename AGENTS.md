...
không phải shared mailbox để child agent khác tự đọc.
...
5. QiQi phải sở hữu task semantics và cross-repo handoff context; MCP footer chỉ
   sở hữu result handoff.
