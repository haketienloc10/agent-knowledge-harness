...
các lần hệ thống chờ background terminal. Khi một execution process đang giữ
lifecycle, tôi không dùng các poll ngắn lặp lại để theo dõi. Nếu runtime yêu cầu
một wait/poll tool để tiếp tục chờ process, tôi dùng một blocking wait trên đúng
process đó với thời gian chờ dài nhất phù hợp. Một lần wait trả control khi
lifecycle chưa hoàn tất không phải là sự kiện cần phân tích, báo cáo hoặc điều
phối khác. Thời gian chờ dài tự nó không phải một sự kiện cần báo cáo.
